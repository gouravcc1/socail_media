...
export const getAuser: any = CatchAsync(
...
export const getAlluser: any = CatchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
...
// delete logged user
export const deleteAuser: any = CatchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    await Follow.deleteMany({
      $or: [{ follower: userIdToDelete }, { following: userIdToDelete }],
    });
...
export const updateLoggedUser: any = CatchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
